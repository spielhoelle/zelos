Feature: There should be invoices visible in the admin entries page
  ...
  Scenario: Check invoice index view
    Given I am signed in
      ...
      And there is a customer with the name "Customer1" and the company "ACME"
      ...
      And there is a customer with the name "Customer2" and the company "ACME"
      ...
      And there is a customer with the name "Customer3" and the company "ACME"
      ...
      And there is a customer with the name "Customer4" and the company "Another buisness"
